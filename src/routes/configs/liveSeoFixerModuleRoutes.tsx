...
export const liveSeoFixerModuleRoutes: RouteConfig[] = [
  {
    ...
    children: [
      { path: "", element: <Navigate to="/module/live-seo-fixer/dashboard" replace /> },
      { path: "dashboard", element: <Dashboard /> },
      { path: "projects/:projectId", element: <ProjectDetail /> },
      { path: "projects/:projectId/page-selection", element: <PageSelection /> },
      { path: "projects/:projectId/audit-progress", element: <AuditProgress /> },
      { path: "projects/:projectId/audit-results", element: <AuditResults /> },
      { path: "projects/:projectId/audit-results-grouped", element: <AuditResultsGrouped /> },
      { path: "projects/:projectId/pages/:pageId/audit", element: <PageAudit /> },
