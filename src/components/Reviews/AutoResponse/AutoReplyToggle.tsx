  ...
  return <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">Create custom response templates for different star ratings. Templates will be automatically sent when reviews are received.</p>
        </div>
      </div>
