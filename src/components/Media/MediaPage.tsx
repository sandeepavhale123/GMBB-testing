      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="space-y-4">
            {/* Views Count */}
            <div>
              <div className="text-3xl font-bold text-gray-900">12.4k views</div>
            ...
            <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden">
              <img 
                src={mediaItems[0]?.url || '/lovable-uploads/02f59897-014c-45f5-a518-c8d08dadba75.png'} 
            ...
            <Button 
              ...
              onClick={() => handleViewImage(mediaItems[0])}
            >
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="space-y-4">
            {/* Upload Stats */}
            <div>
              <div className="text-5xl font-bold text-gray-900">354</div>
