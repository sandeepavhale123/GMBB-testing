...
export const MetricsCards: React.FC<MetricsCardsProps> = ({
  ...
  const { t } = useI18nNamespace("GeoRanking/metricsCards");
  ...
  const handleGetInsights = () => {
    ...
    if (pathname.startsWith("/module/geo-ranking/")) {
      ...
      navigate(
        `/module/geo-ranking/aiChatBox/${projectId}?${params.toString()}`
      );
    } else {
          ...
          <div className="flex items-center justify-between h-full">
            <div className="flex-1">
              <div className="text-xs text-blue-600 font-medium mb-1">
                {t("metricsCards.overallVisibility.label")}
              </div>
      ...
      <div className={isShareableView ? "lg:col-span-4" : "lg:col-span-3"}>
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 py-8 rounded-lg h-full">
          <div className="text-xs text-orange-600 font-medium mb-1">
            {t("metricsCards.totalKeywords.label")}
          </div>
      ...
      {!isShareableView && (
        <div className="lg:col-span-3">
          <div className="bg-gradient-to-br from-blue-600 to-purple-600 p-4  py-8 rounded-lg h-full">
            <div className="text-xs text-blue-100 font-medium mb-2 text-center">
              {t("metricsCards.aiGenie.label")}
            </div>
            <Button
              size="sm"
