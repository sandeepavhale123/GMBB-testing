...
export const GeoRankingMapSection: React.FC<GeoRankingMapSectionProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <Card className="absolute left-6 bg-white/95 backdrop-blur-sm shadow-lg z-50" style={{ top: '130px' }}>
      ...
      <Card className="absolute right-6 bg-white/95 backdrop-blur-sm shadow-lg z-50" style={{ top: '130px' }}>
        <CardContent className="p-4">
