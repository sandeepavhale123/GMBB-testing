      ...
      >
        ...
        {!isMobile && <div className="flex-1 text-center"></div>}
          <Button
            ...
            className="bg-white hover:bg-dark hover:text-white text-black fixed right-0 top-1/2 -translate-y-1/2 w-20 h-20 flex-col p-2 z-[9999] rounded-l-md rounded-r-none hidden sm:flex"
          >
