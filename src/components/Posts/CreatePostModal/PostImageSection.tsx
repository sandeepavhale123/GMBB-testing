...
export const PostImageSection: React.FC<PostImageSectionProps> = ({
  ...
  return <div className="space-y-3">
      ...
      <div className={`border-2 border-dashed rounded-lg p-4 sm:p-6 text-center transition-all cursor-pointer ${dragActive ? 'border-blue-400 bg-blue-50' : image ? 'border-green-400 bg-green-50' : 'border-gray-300 hover:border-gray-400'}`} onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop} onClick={() => setIsGalleryModalOpen(true)}>
        {imageDisplay ? <div className="space-y-2">
      ...
      <Dialog open={isGalleryModalOpen} onOpenChange={setIsGalleryModalOpen}>
        <DialogContent className="max-w-[90vw] w-[90vw] h-[90vh] max-h-[90vh] p-0 flex flex-col overflow-hidden">
          ...
          <DialogFooter className="p-6 pt-4 hidden ">
            ...
            <Button onClick={() => setIsGalleryModalOpen(false)} className="hidden ">
              Apply
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <MediaUploadModal isOpen={isMediaUploadModalOpen} onClose={() => {
