...
export const PostPreview: React.FC<PostPreviewProps> = ({
  ...
  return <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
      ...
      {/* Image */}
      {data.image ? <img src={URL.createObjectURL(data.image)} alt="Post" className="w-full h-48 object-cover" /> : <div className="h-48 bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
