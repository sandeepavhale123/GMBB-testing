...
export const BusinessManagement: React.FC = () => {
  ...
  const {
    ...
    isRefreshing,
    refreshError
  } = useAppSelector(state => state.businessInfo);
  ...
  return <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <BusinessProfileCard businessInfo={businessInfo} statistics={statistics} isLoading={isLoading} isRefreshing={isRefreshing} activeTab={activeTab} onTabChange={setActiveTab} onRefresh={handleRefresh} />

      {/* Tab Content */}
      <div className="bg-white rounded-lg border border-gray-200">
        {activeTab === 'business-info' && <div className="p-8">
            {isLoading ? <div className="space-y-6">
              ...
              </div> : transformedBusinessInfo ? <div className="space-y-6">
                {/* Business Details */}
        ...
        {activeTab === 'opening-hours' && <div className="p-6">
        ...
        {activeTab === 'edit-log' && <div className="p-6">
            {isLoading ? <div className="space-y-4">
              ...
              </div> : transformedEditLogs.length > 0 ? <div className="space-y-4">
                <h3 className="text-lg font-semibold mb-4">Recent Changes</h3>
                {transformedEditLogs.map((log, index) => <div key={index} className="border-b border-gray-200 pb-4 last:border-b-0">
