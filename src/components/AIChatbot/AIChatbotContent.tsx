...
const ScrollArea = lazyImport(() => import("../ui/scroll-area").then((mod) => ({ default: mod.ScrollArea })));
...
const AlertDialog = lazyImport(() => import("../ui/alert-dialog").then((mod) => ({ default: mod.AlertDialog })));
    ...
    <div className="h-full flex flex-col lg:flex-row relative">
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <Suspense fallback={<div className="p-4 text-center text-gray-500">Loading History...</div>}>
      ...
      <div className="flex-1 flex flex-col h-screen lg:h-auto bg-background dark:bg-[#212121]">
        ...
        <div className="flex-1 min-h-0">
          <Suspense fallback={<div className="text-center p-4">Loading Messages...</div>}>
                ...
                {isLoadingMessages ? (
                  ...
                  messages.map((message) => (
                    ...
                    >
                      ...
                      {/* Message Content */}
                      <div
                        className={`flex-1 max-w-[85%] sm:max-w-[80%] ${message.type === "user" ? "text-right" : ""}`}
                      >
                        <div
