            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                <div className="text-2xl font-bold text-yellow-600">
                  {truncateToTwoDecimals(healthData?.data?.avgRating)}
                </div>
                <h3 className="font-semibold text-sm text-muted-foreground">
                  GMB Avg Rating
                </h3>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                <div className="text-2xl font-bold text-green-600">
                  {truncateToTwoDecimals(healthData?.data?.gmbPhotos)}
                </div>
                <h3 className="font-semibold text-sm text-muted-foreground">
                  No. Of GMB Photos
                </h3>
                    ...
                    <PieChart>
                      <Pie
                        data={[
                          {
                            name: "Passed Tests",
                            value: healthData?.data?.successScore || 0,
                            fill: "#22c55e",
                          },
                          {
                            name: "Failed Tests",
                            value: healthData?.data?.failedScore || 0,
                            fill: "#ef4444",
                          },
                        ]}
                        cx="50%"
