...
export const SetupComponent: React.FC<SetupComponentProps> = ({
  ...
  const { t } = useI18nNamespace("Dashboard/setupComponent");

  const SETUP_MODULES: Omit<SetupModule, "status">[] = [
    {
      key: "gmbInfo",
      label: t("modules.gmbInfo.label"),
      description: t("modules.gmbInfo.description"),
    },
    {
      key: "reviewData",
      label: t("modules.reviewData.label"),
      description: t("modules.reviewData.description"),
    },
    {
      key: "insightData",
      label: t("modules.insightData.label"),
      description: t("modules.insightData.description"),
    },
    {
      key: "qaData",
      label: t("modules.qaData.label"),
      description: t("modules.qaData.description"),
    },
    {
      key: "postData",
      label: t("modules.postData.label"),
      description: t("modules.postData.description"),
    },
    {
      key: "mediaData",
      label: t("modules.mediaData.label"),
      description: t("modules.mediaData.description"),
    },
  ];
            ...
            >
              ...
              <CardContent className="pt-0">
                <p className="text-xs text-gray-600 leading-relaxed">
                  ...
                  {status === "processing" &&
                    t("status.processing", { description: module.description })}
      ...
      {isLoading && (
        <div className="text-center py-4">
          <div className="inline-flex items-center gap-2 text-gray-600">
            ...
            />
            <span className="text-sm">{t("loading.checking")}</span>
          </div>
        </div>
      )}
    </div>
