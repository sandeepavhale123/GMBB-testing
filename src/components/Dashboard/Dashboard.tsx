...
import { BarChart3, FileText, MessageSquare, MapPin, TrendingUp, Loader2 } from 'lucide-react';
import { useAppSelector, useAppDispatch } from '../../hooks/useRedux';
import { useListingContext } from '@/context/ListingContext';
import { fetchInsightsSummary, fetchVisibilityTrends } from '../../store/slices/insightsSlice';

// Lazy load heavy components for better performance
const TrafficSourcesChart = lazy(() => import('./TrafficSourcesChart').then(module => ({ default: module.TrafficSourcesChart })));
const CreatePostCard = lazy(() => import('./CreatePostCard').then(module => ({ default: module.CreatePostCard })));
const ScheduledPostCard = lazy(() => import('./ScheduledPostCard').then(module => ({ default: module.ScheduledPostCard })));
const GeoRankingPage = lazy(() => import('../GeoRanking/GeoRankingPage').then(module => ({ default: module.GeoRankingPage })));
const InsightsComparisonChart = lazy(() => import('./InsightsComparisonChart').then(module => ({ default: module.InsightsComparisonChart })));
