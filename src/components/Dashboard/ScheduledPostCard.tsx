    ...
    <Card className="col-span-full">
      <CardHeader className="pb-3 sm:pb-4">
        <CardTitle className="text-base sm:text-lg font-semibold flex items-center justify-between">
          ...
          <Button variant="link" className="text-xs sm:text-sm p-0 h-auto" onClick={handleViewAll}>
            View All
          </Button>
        </CardTitle>
      </CardHeader>
      <CardContent>
        {loading ? (
          ...
          <div className="text-center py-8">
            <p className="text-sm text-red-600 mb-2">Failed to load scheduled posts</p>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mb-2">No scheduled posts</p>
            <p className="text-xs text-gray-400">Create a new post to get started</p>
          </div>
        ) : (
          <>
            {/* Desktop Table View */}
