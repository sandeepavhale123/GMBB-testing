...
export const InsightsComparisonChart: React.FC = () => {
  ...
  if (comparisonError) {
    return (
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">6-Month Performance Comparison</CardTitle>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg font-semibold">6-Month Performance Comparison</CardTitle>
        <p className="text-sm text-gray-600">Historical trends for key metrics over the last 6 months</p>
      </CardHeader>
      <CardContent>
        {isLoadingComparison ? (
