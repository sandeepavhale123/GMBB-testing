...
export const HealthScoreSection: React.FC = () => {
  ...
  const { t } = useI18nNamespace("Dashboard/healthScoreSection");
              ...
              <CircularProgress value={healthScore.score} className="mx-auto">
                <div className="text-center">
                  ...
                  <div
                    className={cn(
                      "text-sm font-medium",
                      getStatusColor(healthScore.status)
                    )}
                  >
                    {healthScore.status.charAt(0).toUpperCase() +
                      healthScore.status.slice(1)}
                  </div>
                </div>
              </CircularProgress>
