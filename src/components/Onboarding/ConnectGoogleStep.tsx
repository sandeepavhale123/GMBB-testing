      ...
      <Card className="p-8 border-2 border-gray-200">
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            ...
            <span className="text-green-800">View and manage your business information</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <CheckCircle className="h-5 w-5 text-green-600" />
            <span className="text-green-800">Read and respond to customer reviews</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <CheckCircle className="h-5 w-5 text-green-600" />
            <span className="text-green-800">Create and manage posts</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
            <CheckCircle className="h-5 w-5 text-green-600" />
            <span className="text-green-800">Access performance insights</span>
          </div>
        </div>
