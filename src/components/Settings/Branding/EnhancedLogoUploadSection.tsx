...
export const EnhancedLogoUploadSection: React.FC<EnhancedLogoUploadSectionProps> = ({
  ...
  const validateAndUpload = (file: File, type: 'light' | 'dark') => {
    ...
    toast({
      title: `${type === 'light' ? 'Light' : 'Dark'} logo uploaded`,
  ...
  const removeLogo = (type: 'light' | 'dark') => {
    ...
    toast({
      title: `${type === 'light' ? 'Light' : 'Dark'} logo removed`,
          ...
          <div className="space-y-3">
            ...
            <div 
              className={`w-full h-24 border-2 border-dashed rounded-lg flex items-center justify-center bg-white transition-colors ${
                dragOver === 'light' ? 'border-blue-400 bg-blue-50' : 'border-gray-300'
              }`}
            ...
            <div>
              <p className="text-xs text-gray-500 mb-2">PNG, JPG, SVG up to 2MB. Recommended: 200x60px</p>
              <input
          ...
          <div className="space-y-3">
            ...
            <div 
              className={`w-full h-24 border-2 border-dashed rounded-lg flex items-center justify-center transition-colors ${
                dragOver === 'dark' ? 'border-blue-400 bg-gray-800' : 'border-gray-300 bg-gray-900'
              }`}
              style={{
