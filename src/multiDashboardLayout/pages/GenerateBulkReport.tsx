...
const weeklyFrequencyOptions = [
  ...
  { value: "last-5-weeks", label: "Last 5 Weeks" },
];
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    >
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          handleReportSectionChange(section.id, checked as boolean)
                        }
                      />
                      <Label
                        htmlFor={section.id}
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <DateRangePicker
                          ...
                          placeholder="Select date range for one-time report"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
              ...
              {(watchScheduleType === "weekly" || watchScheduleType === "monthly") && (
