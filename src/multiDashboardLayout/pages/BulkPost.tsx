      ...
      <div className="aspect-w-16 aspect-h-9 bg-muted rounded-lg overflow-hidden">
        {post.image ? (
              ...
              if (parent) {
                parent.innerHTML = `
                  <div class="w-full h-full flex items-center justify-center bg-muted rounded-lg">
                    <span class="text-xs text-muted-foreground text-center px-2">Image not available</span>
                  </div>
                `;
              }
            }}
          ...
          <div className="w-full h-full flex items-center justify-center bg-muted rounded-lg">
            <span className="text-xs text-muted-foreground text-center px-2">Image not available</span>
          </div>
        )}
      </div>
    </div>
