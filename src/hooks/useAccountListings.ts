...
import { accountListingsApi, AccountListingRequest, AccountListingResponse } from '../api/accountListingsApi';
...
const transformLocationToListing = (location: any) => ({
  ...
  store_code: location.storeCode !== "" ? location.storeCode : "Not found"  , // Use ID as store code since not provided
