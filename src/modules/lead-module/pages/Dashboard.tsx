...
import { Users, TrendingUp, Mail, Target, Plus, Eye } from 'lucide-react';
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              { name: 'Sarah Johnson', email: 'sarah@example.com', status: 'Contacted', source: 'Social Media' },
              { name: 'Mike Davis', email: 'mike@example.com', status: 'Qualified', source: 'Referral' },
              { name: 'Lisa Wilson', email: 'lisa@example.com', status: 'New', source: 'Email Campaign' }
            ].map((lead, index) => (
