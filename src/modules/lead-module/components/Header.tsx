...
export const Header: React.FC = () => {
  ...
  return (
    <header 
      className="fixed top-0 left-0 right-0 z-0 w-full px-4 py-3 border-b border-border"
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="border-l border-border/30 pl-3 hidden md:block ">
              <h1 className="text-md font-semibold text-white mb-0 p-0">Lead Management Tool</h1>
              <p className="text-sm text-white mt-0 p-0">Manage and track your leads effectively</p>
            </div>
          </div>
        </div>
