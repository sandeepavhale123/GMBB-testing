        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="border-l border-border/30 pl-3 hidden md:block ">
              <h1 className="text-md font-semibold text-white mb-0 p-0">SEO Fixer</h1>
              <p className="text-sm text-white mt-0 p-0">Real-time SEO optimization and monitoring.</p>
            </div>
          </div>
        </div>
