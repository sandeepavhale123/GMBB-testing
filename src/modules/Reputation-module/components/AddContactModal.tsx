            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Popover open={countryCodeOpen} onOpenChange={setCountryCodeOpen}>
                  ...
                  <PopoverContent className="w-[300px] p-0 z-[9999]" align="start" side="bottom" sideOffset={4} onOpenAutoFocus={(e) => e.preventDefault()} onInteractOutside={(e) => e.preventDefault()} onPointerDownOutside={(e) => e.stopPropagation()} onCloseAutoFocus={(e) => e.preventDefault()}>
                    <Command shouldFilter={true} onKeyDown={(e) => { if (e.key === 'Escape') { e.stopPropagation(); } }}>
