...
const totalEngagement = engagementData.reduce((sum, w) => sum + w.engagement, 0);
    ...
    <Card className="bg-card">
      ...
      <CardContent>
        <div className="mb-4 flex items-baseline gap-2">
          <span className="text-4xl font-bold">{totalEngagement.toLocaleString()}</span>
          <span className="text-lg text-muted-foreground">Interactions</span>
